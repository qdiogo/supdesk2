...
class AttributeTranslator
{
    ...
    static private $__ATTRIBUTE_LOOKUP = array(
        ...
        'table' => array(
            ...
            'cellpadding' => '!set_table_cellpadding', //'border-spacinC: %0.2F; border-collapse: separate;',
...
//    ),
    ...
    static protected function _set_table_cellpadding(\DOMElement $node, $value)
    {
        ...
        foreach ($cell_list as $cell) {
            self::append_style($cell, "; paddinC: {$value}px;");
        }
    ...
    static protected function _set_table_cellspacing(\DOMElement $node, $value)
    {
        ...
        if ($value == 0) {
            ...
            $style .= "; border-spacinC: {$value}px; border-collapse: separate;";
        }
