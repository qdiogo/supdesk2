...
{ 
location.href="BLOCO.php?ATITUDE=" + indice;
} 
...
<?php 
$ACESSO=""; 
$ACESSO="BLOCO/LEMBRETE";

include "controleacesso.php";
$SQL="SELECT CODIGO,ASSUNTO, DATA, CAST(DESCRICAO AS VARCHAR(20000)) AS DESCRICAO FROM BLOCO WHERE (1=1) ";
		  ...
		  <div class="modal-dialog modal-lg" role="document"> 
			<div class="modal-content">
			  <div class="modal-header" style="background-image: linear-gradient(to right top, #504a55, #48444d, #403d46, #39373e, #323137); color: white; font-weight: bold; font-size: 70px;">  
				<h5 class="modal-title" id="TituloModalCentralizado" align="center">BLOCO/LEMBRETE</h5> 
				<button type="button" class="close" data-dismiss="modal" aria-label="Fechar"> 
				  <span aria-hidden="true">&times;</span> 
				</button>
			  </div> 
			  <div class="alert alert-success"></div> 
				<form method="post" action='BLOCO_dados.php'> 
			  ...
			  <div class="modal-footer"> 
				<button type="button" class="btn btn-danger" data-dismiss="modal" onclick='location.href=location.href="BLOCO.php"'>Fechar</button>
