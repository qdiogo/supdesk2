	   ...
	   While ($dia_semana < 7)
	   {
		  If ($cont_mes <= $t_mes)
		  {
			 If ($dia_semana == $cont_semana) //celulas de dias do mes
			 {
				...
				$w_tabela=ibase_query(ibase_connect(str_replace("'", "", "gasuporte.sytes.net/30500:F:\SGBD\SUPDESK\'$CNPJ\pessoal.fdb"), 'SYSDBA', 's@bia#:)ar@ra2021Ga','ISO8859_1', '9000', '1'),$SQL2); 
