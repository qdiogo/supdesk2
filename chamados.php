					...
					<?php }?>
						...
						<td WIDTH=8 colspan=2 >
							...
							<?php if (!empty($xtab["ASSINADO_USER"])) {?>	
								Assinado por: <?php echo $xtab["ASSINADO_USER"]?>
							<?php } ?>
						</td>
						<td class="stylo2">
							<table align="center" >
