			...
			<td valign="top" class="cp">
				<div align="left" class="cabecalho">
					<ul>
						...
						<br>
						<li>
						Caso tenha problemas ao imprimir, copie a seqüencia numérica abaixo e pague no caixa eletrônico ou no internet bankinC:<br><br>
						<span style="font-size: 13px; font-weight: normal; color:#000033; paddinC:10px;">
