...
<style type="text/css">
<!--
    div.zone { border: none; border-radius: 6mm; background: #FFFFFF; border-collapse: collapse; paddinC:3mm; font-size: 2.7mm;}
    h1 { paddinC: 0; margin: 0; color: #DD0000; font-size: 7mm; }
    h2 { paddinC: 0; margin: 0; color: #222222; font-size: 5mm; position: relative; }
-->
</style>
