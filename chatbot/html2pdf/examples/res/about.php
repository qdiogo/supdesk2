<style type="text/css">
<!--
    table.page_header {width: 100%; border: none; background-color: #DDDDFF; border-bottom: solid 1mm #AAAADD; paddinC: 2mm }
    table.page_footer {width: 100%; border: none; background-color: #DDDDFF; border-top: solid 1mm #AAAADD; paddinC: 2mm}
    div.note {border: solid 1mm #DDDDDD;background-color: #EEEEEE; paddinC: 2mm; border-radius: 2mm; width: 100%; }
