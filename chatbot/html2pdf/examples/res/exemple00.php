...
<page style="font-size: 14px">
            ...
            <td border="1" rowspan="2">
                <table class="test1">
                    <tr>
                        ...
                        <td style="border: solid 2px #000077; paddinC: 2mm">
    ...
    <table style="border: solid 5mm #770000; paddinC: 5mm;" cellspacing="0" >
        <tr>
            <td style="border: solid 3mm #007700; paddinC: 2mm;"><img src="./res/off.png" alt="" style="width: 20mm"></td>
        </tr>
    </table>
