...
$buffer = PhpMyAdmin\OutputBufferinC::getInstance();
$buffer->start();
if (!defined('TESTSUITE')) {
    register_shutdown_function(
        function () {
            echo PhpMyAdmin\OutputBufferinC::getInstance()->getContents();
        }
    );
}
...
$js_messages['strTooManyInputs'] = __(
    "WarninC: a form on this page has more than %d fields. On submission, "
