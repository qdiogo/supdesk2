...
class __TwigTemplate_e2dc3b0aa1708ddba867f0a07aa8d65ca892884f099104ceff059f64242ead72 extends \Twig\Template
{
    ...
    ";
        ...
        if (((isset($context["handler"]) ? $context["handler"] : null) != "PhpMyAdmin\\Plugins\\Import\\Upload\\UploadNoplugin")) {
            ...
            // line 9
            echo "            ";
            $context["ajax_url"] = (("import_status.php?id=" . (isset($context["upload_id"]) ? $context["upload_id"] : null)) . PhpMyAdmin\Url::getCommonRaw(["import_status" => 1], "&"));
            // line 12
            echo "            ";
...
";
    ...
    {
        return new Source("", "display/import/javascript.twig", "C:\\suporte\\GA\\phpadmin\\templates\\display\\import\\javascript.twig");
    }
}
