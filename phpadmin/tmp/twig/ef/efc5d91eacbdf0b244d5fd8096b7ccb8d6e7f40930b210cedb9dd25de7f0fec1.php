...
class __TwigTemplate_839d451d921228825e9fc10d8d4e9082afa183645f21e5945153f2e725945afd extends \Twig\Template
{
...
$context["partition"], "getDataLength", [], "method"), 3, 1);
                // line 64
                echo "                            <span>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["data_length"]) ? $context["data_length"] : null), 0, [], "array"), "html", null, true);
                echo "</span>
                            <span class=\"unit\">";
                // line 65
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["data_length"]) ? $context["data_length"] : null), 1, [], "array"), "html", null, true);
                echo "</span>
                        </td>
                        <td class=\"value\">
                            ";
...
$context["partition"], "getIndexLength", [], "method"), 3, 1);
                // line 73
                echo "                            <span>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["index_length"]) ? $context["index_length"] : null), 0, [], "array"), "html", null, true);
                echo "</span>
                            <span class=\"unit\">";
                // line 74
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["index_length"]) ? $context["index_length"] : null), 1, [], "array"), "html", null, true);
                echo "</span>
                        </td>
                        <td>";
                // line 76
...
$context["sub_partition"], "getIndexLength", [], "method"), 3, 1);
    ...
    <fieldset class=\"tblFooters print_ignore\">
        ...
        if (twig_test_empty((isset($context["partitions"]) ? $context["partitions"] : null))) {
            ...
            // line 137
            echo "                ";
            echo PhpMyAdmin\Util::linkOrButton((isset($context["remove_url"]) ? $context["remove_url"] : null), _gettext("Remove partitioning"), ["class" => "button ajax", "id" => "remove_partitioning"]);
            // line 140
            echo "
...
";
    ...
    {
        return new Source("", "table/structure/display_partitions.twig", "C:\\suporte\\GA\\phpadmin\\templates\\table\\structure\\display_partitions.twig");
    }
}
