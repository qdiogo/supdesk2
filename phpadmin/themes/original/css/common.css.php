...
table th,
table td {
    paddinC:            0.1em 0.5em 0.1em 0.5em;
    margin:             0.1em;
    vertical-align:     top;
}
...
div.error {
    ...
    if ($GLOBALS['text_dir'] === 'ltr') { ?>
        ...
        paddinC:            0.1em 0.1em 0.1em 42px;
    <?php
    } else { ?>
        background-position: 99% 50%;
        paddinC:            0.1em 40px 0.1em 0.1em;
        <?php
    }
?>
}
...
fieldset.confirmation legend {
    ...
    if ($GLOBALS['text_dir'] === 'ltr') { ?>
        ...
        paddinC:            0.2em 0.2em 0.2em 25px;
        <?php
    } else { ?>
        background-position: 97% 50%;
        paddinC:            0.2em 25px 0.2em 0.2em;
        <?php
    }
?>
}
...
#topmenu {
    margin-top:         0.5em;
    paddinC:            0.1em 0.3em 0.1em 0.3em;
}
...
/**
 ...
 .ajax_notification {
    ...
    margin-bottom: 0;
    margin-left: auto;
    paddinC: 3px 5px;   /** Keep a little space on the sides of the text */
    width: 350px;
...
.ui-tpicker-grid-label { background: none; border: none; margin: 0; paddinC: 0; }
...
#pma_console .message.pendinC:before {
    opacity: .3;
}
