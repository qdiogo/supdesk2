...
div.error {
    ...
    <?php if ($GLOBALS['text_dir'] === 'ltr') : ?>
        ...
        paddinC: 10px 10px 10px 10px;
    <?php else : ?>
        background-position: 99% 50%;
        paddinC: 10px 35px 10px 10px;
        <?php
    endif; ?>
...
p.notice {
    ...
    <?php if ($GLOBALS['text_dir'] === 'ltr') : ?>
        background-position: 10px 50%;
        paddinC: 10px 10px 10px 25px;
    <?php else : ?>
        background-position: 99% 50%;
        paddinC: 25px 10px 10px 10px
    <?php endif; ?>
    -moz-border-radius: 5px;
    -webkit-border-radius: 5px;
    border-radius: 5px;
...
/**
 ...
 .ajax_notification {
    ...
    paddinC: 5px;   /** Keep a little space on the sides of the text */
    width: 350px;
