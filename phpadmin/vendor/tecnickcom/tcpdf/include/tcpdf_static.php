...
class TCPDF_STATIC {
	 ...
	 * @public static
	 */
	public static $alias_group_tot_pages = '{:ptC:}';

	/**
	 * String alias for group page number.
	 * @public static
	 */
	public static $alias_group_num_page = '{:pnC:}';
	...
	* @since 5.9.121 (2011-09-28)
	 ...
	 * This is a wrapper for the preg_split function to avoid the buC: https://bugs.php.net/bug.php?id=45850
