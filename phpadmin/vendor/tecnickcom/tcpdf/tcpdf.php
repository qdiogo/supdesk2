...
class TCPDF {
	...
	/**
	 * Boolean flaC: if true convert vector images (SVG, EPS) to raster image using GD or ImageMagick library.
	 * @protected
	...
	/**
	 * Boolean flaC: if true enables font subsetting by default.
	 * @protected
	 ...
	 * <li>['TrimBox'] : the intended dimensions of the finished page after trimminC:</li>
	 ...
	 * @param $fontstyle (string) Font style. Possible values are (case insensitive):<ul><li>empty strinC: regular</li><li>B: bold</li><li>I: italic</li><li>U: underline</li><li>D: line-through</li><li>O: overline</li></ul> or any combination. The default value is regular.
	 ...
	 * @param $style (string) Font style. Possible values are (case insensitive):<ul><li>empty strinC: regular (default)</li><li>B: bold</li><li>I: italic</li><li>BI or IB: bold italic</li></ul>
	 ...
	 * @param $style (string) Font style. Possible values are (case insensitive):<ul><li>empty strinC: regular</li><li>B: bold</li><li>I: italic</li><li>U: underline</li><li>D: line through</li><li>O: overline</li></ul> or any combination. The default value is regular. Bold and italic styles do not apply to Symbol and ZapfDingbats basic fonts or other fonts when not defined.
	 ...
	 * @param $align (string) Allows to center or align the text. Possible values are:<ul><li>L or empty strinC: left align (default value)</li><li>C: center</li><li>R: right align</li><li>J: justify</li></ul>
	 ...
	 * @param $txt (string) String to print
	 * @param $border (mixed) Indicates if borders must be drawn around the cell. The value can be a number:<ul><li>0: no border (default)</li><li>1: frame</li></ul> or a string containing some or all of the following characters (in any order):<ul><li>L: left</li><li>T: top</li><li>R: right</li><li>B: bottom</li></ul> or an array of line styles for each border group - for example: array('LTRB' => array('width' => 2, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0, 0, 0)))
	 * @param $align (string) Allows to center or align the text. Possible values are:<ul><li>L or empty strinC: left align</li><li>C: center</li><li>R: right align</li><li>J: justification (default value when $ishtml=false)</li></ul>
	 * @param $fill (boolean) Indicates if the cell background must be painted (true) or transparent (false).
	...
	public function Output($name='doc.pdf', $dest='I') {
		...
		switch($dest) {
			...
			case 'D': {
				...
				header('Content-Transfer-EncodinC: binary');
				TCPDF_STATIC::sendOutputData($this->getBuffer(), $this->bufferlen);
				break;
			}
			case 'F':
			...
			case 'E': {
				...
				$retval .= ' name="'.$name.'"'."\r\n";
				$retval .= 'Content-Transfer-EncodinC: base64'."\r\n";
	...
	/**
	 * Set line style.
	 * @param $style (array) Line style. Array with keys among the followinC:
	 * <ul>
	 ...
	 * @param $border_style (array) Border style of rectangle. Array with keys among the followinC:
	 * <ul>
	 ...
	 * @param $rx (float) Horizontal radius.
	 * @param $ry (float) Vertical radius (if ry = 0 then is a circle, see Circle()). Default value: 0.
	 * @param $xanC: (float) Angle between the X-axis and the major axis of the ellipse. Default value: 0.
	 ...
	 * @param $style (string) Style of rendering. See the getPathPaintOperator() function for more information.
	 * @param $line_style (array) Line style of polygon. Array with keys among the followinC:
	 * <ul>
	 ...
	 * @param $style (string) Style of rendering. See the getPathPaintOperator() function for more information.
	 * @param $line_style (array) Line style of polygon sides. Array with keys among the followinC:
	 * <ul>
	 ...
	 * <ul>
	 *	 <li>D or empty strinC: Draw (default).</li>
	 *	 <li>F: Fill.</li>
	...
	protected function _putbookmarks() {
		...
		foreach ($this->outlines as $i => $o) {
			if ($o['l'] > 0) {
				...
				if ($o['l'] > $level) {
					//Level increasinC: set first pointer
	 ...
	 * WARNINC: This is experimental and currently do not work.
	 ...
	 * @param $bm (string) blend mode, one of the followinC: Normal, Multiply, Screen, Overlay, Darken, Lighten, ColorDodge, ColorBurn, HardLight, SoftLight, Difference, Exclusion, Hue, Saturation, Color, Luminosity
	 ...
	 * @param $defaultunit (string) Default unit (can be one of the followinC: %, em, ex, px, in, mm, pc, pt).
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	 ...
	 * @param $params (array) Array of parameters: enabled (boolean) set to true to enable shadow; depth_w (float) shadow width in user units; depth_h (float) shadow height in user units; color (array) shadow color or false to use the stroke color; opacity (float) Alpha value: real value from 0 (transparent) to 1 (opaque); blend_mode (string) blend mode, one of the followinC: Normal, Multiply, Screen, Overlay, Darken, Lighten, ColorDodge, ColorBurn, HardLight, SoftLight, Difference, Exclusion, Hue, Saturation, Color, Luminosity.
	 * @since 5.9.174 (2012-07-25)
	 * @public
	*/
