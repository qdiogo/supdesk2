...
EOT;
    ...
    public static function create($mime, $data)
    {
        $data = array(
            ...
            . ' svC:font-family="\'Arial Unicode MS\'" style:font-pitch="variable"/>'
            . '<style:font-face style:name="DejaVu Sans1"'
            . ' svC:font-family="\'DejaVu Sans\'" style:font-pitch="variable"/>'
            . '<style:font-face style:name="HG Mincho Light J"'
            . ' svC:font-family="\'HG Mincho Light J\'" style:font-pitch="variable"/>'
            . '<style:font-face style:name="DejaVu Serif"'
            . ' svC:font-family="\'DejaVu Serif\'" style:font-family-generic="roman"'
            . ' style:font-pitch="variable"/>'
            . '<style:font-face style:name="Thorndale"'
            . ' svC:font-family="Thorndale" style:font-family-generic="roman"'
            . ' style:font-pitch="variable"/>'
            . '<style:font-face style:name="DejaVu Sans"'
            . ' svC:font-family="\'DejaVu Sans\'" style:font-family-generic="swiss"'
            . ' style:font-pitch="variable"/>'
            . '</office:font-face-decls>'
            . '<office:styles>'
