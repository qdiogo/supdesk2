...
* [#455](https://github.com/ckeditor/ckeditor-dev/issues/455): Added [Advanced Content Filter](https://docs.ckeditor.com/#!/guide/dev_acf) integration with the [Justify](www.syshosp.com.br/addon/justify) plugin.
...
* [#579](https://github.com/ckeditor/ckeditor-dev/issues/579): Fixed: Internal `cke_table-faked-selection-table` class is visible in the Stylesheet Classes field of the [Table Properties](www.syshosp.com.br/addon/table) dialog.
* [#545](https://github.com/ckeditor/ckeditor-dev/issues/545): [Edge] Fixed: Error thrown when pressing the [Select All](https://ckeditor.com/addon/selectall) button in [Source Mode](www.syshosp.com.br/addon/sourcearea).
* [#582](https://github.com/ckeditor/ckeditor-dev/issues/582): Fixed: Double slash in the path to stylesheet needed by the [Table Selection](www.syshosp.com.br/addon/tableselection) plugin. Thanks to [Marius Dumitru Florea](https://github.com/mflorea)!
* [#491](https://github.com/ckeditor/ckeditor-dev/issues/491): Fixed: Unnecessary dependency on the [Editor Toolbar](www.syshosp.com.br/addon/toolbar) plugin inside the [Notification](www.syshosp.com.br/addon/notification) plugin.
* [#646](https://github.com/ckeditor/ckeditor-dev/issues/646): Fixed: Error thrown into the browser console after opening the [Styles Combo](www.syshosp.com.br/addon/stylescombo) plugin menu in the editor without any selection.
* [#501](https://github.com/ckeditor/ckeditor-dev/issues/501): Fixed: Double click does not open the dialog for modifying anchors inserted via the [Link](www.syshosp.com.br/addon/link) plugin.
...
* Updated the [SCAYT](www.syshosp.com.br/addon/scayt) (Spell Check As You Type) plugin:
...
* [#413](https://github.com/ckeditor/ckeditor-dev/issues/413): Added Paste as Plain Text keyboard shortcut to the [Accessibility Help](www.syshosp.com.br/addon/a11yhelp) instructions.

Fixed Issues:

* [#515](https://github.com/ckeditor/ckeditor-dev/issues/515): [Chrome] Fixed: Mouse actions on CKEditor scrollbar throw an exception when the [Table Selection](www.syshosp.com.br/addon/tableselection) plugin is loaded.
...
* [#478](https://github.com/ckeditor/ckeditor-dev/issues/478): [Chrome] Fixed:  Error thrown by the [Enter Key](www.syshosp.com.br/addon/enterkey) plugin when pressing <kbd>Enter</kbd> with no selection.
* [#424](https://github.com/ckeditor/ckeditor-dev/issues/424): Fixed: Error thrown by [Tab Key Handling](www.syshosp.com.br/addon/tab) and [Indent List](www.syshosp.com.br/addon/indentlist) plugins when pressing <kbd>Tab</kbd> with no selection in inline editor.
* [#476](https://github.com/ckeditor/ckeditor-dev/issues/476): Fixed: Anchors inserted with the [Link](www.syshosp.com.br/addon/link) plugin on collapsed selection cannot be edited.
* [#417](https://github.com/ckeditor/ckeditor-dev/issues/417): Fixed: The [Table Resize](www.syshosp.com.br/addon/tableresize) plugin throws an error when used with a table with only header or footer rows.
...
* [#534](https://github.com/ckeditor/ckeditor-dev/issues/534): [IE] Fixed: [Paste from Word](www.syshosp.com.br/addon/pastefromword) does not work in Quirks Mode.
...
* [#13793](http://dev.ckeditor.com/ticket/13793): The [`embed_provider`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-embed_provider) configuration option for the [Media Embed](www.syshosp.com.br/addon/embed) and [Semantic Media Embed](www.syshosp.com.br/addon/embedsemantic) plugins is no longer preset by default.
* The [UI Color](www.syshosp.com.br/addon/uicolor) plugin now uses a custom color picker instead of the `YUI 2.7.0` library which has some known vulnerabilities (it's a security precaution, there was no security issue in CKEditor due to the way it was used).

New Features:

* [#16755](http://dev.ckeditor.com/ticket/16755): Added the [Table Selection](www.syshosp.com.br/addon/tableselection) plugin that lets you select and manipulate an arbitrary rectangular table fragment (a few cells, a row or a column).
...
* [#16971](http://dev.ckeditor.com/ticket/16971): Added support for color in the `background` property containing also other styles for table cells in the [Table Tools](www.syshosp.com.br/addon/tabletools) plugin.
* [#16847](http://dev.ckeditor.com/ticket/16847): Added support for parsing and inlining any formatting created using the Microsoft Word style system to the [Paste from Word](www.syshosp.com.br/addon/pastefromword) plugin.
* [#16818](http://dev.ckeditor.com/ticket/16818): Added table cell height parsing in the [Paste from Word](www.syshosp.com.br/addon/pastefromword) plugin.
* [#16850](http://dev.ckeditor.com/ticket/16850): Added a new [`config.enableContextMenu`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-enableContextMenu) configuration option for enabling and disabling the [context menu](www.syshosp.com.br/addon/contextmenu).
...
* [#16935](http://dev.ckeditor.com/ticket/16935): [Chrome] Fixed: Blurring the editor in [Source Mode](www.syshosp.com.br/addon/sourcearea) throws an error.
* [#16825](http://dev.ckeditor.com/ticket/16825): [Chrome] Fixed: Error thrown when destroying a focused inline editor.
* [#16857](http://dev.ckeditor.com/ticket/16857): Fixed: <kbd>Ctrl+Shift+V</kbd> blocked by [Copy Formatting](www.syshosp.com.br/addon/copyformatting).
* [#16845](https://dev.ckeditor.com/ticket/16845): [IE] Fixed: Cursor jumps to the top of the scrolled editor after focusing it when the [Copy Formatting](www.syshosp.com.br/addon/copyformatting) plugin is enabled.
* [#16786](http://dev.ckeditor.com/ticket/16786): Fixed: Added missing translations for the [Copy Formatting](www.syshosp.com.br/addon/copyformatting) plugin.
* [#14714](http://dev.ckeditor.com/ticket/14714): [WebKit/Blink] Fixed: Exception thrown on refocusing a blurred inline editor.
* [#16913](http://dev.ckeditor.com/ticket/16913): [Firefox, IE] Fixed: [Paste as Plain Text](www.syshosp.com.br/addon/pastetext) keystroke does not work.
* [#16968](http://dev.ckeditor.com/ticket/16968): Fixed: [Safari] [Paste as Plain Text](www.syshosp.com.br/addon/pastetext) is not handled by the editor.
* [#16912](http://dev.ckeditor.com/ticket/16912): Fixed: Exception thrown when a single image is pasted using [Paste from Word](www.syshosp.com.br/addon/pastefromword).
* [#16821](http://dev.ckeditor.com/ticket/16821): Fixed: Extraneous `<span>` elements with `height` style stacked when [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#16866](http://dev.ckeditor.com/ticket/16866): [IE, Edge] Fixed: Whitespaces not preserved when [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#16860](http://dev.ckeditor.com/ticket/16860): Fixed: Paragraphs which only look like lists incorrectly transformed into them when [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#16817](http://dev.ckeditor.com/ticket/16817): Fixed: When [pasting from Word](www.syshosp.com.br/addon/pastefromword), paragraphs are transformed into lists with some corrupted data.
* [#16833](http://dev.ckeditor.com/ticket/16833): [IE11] Fixed: Malformed list with headers [pasted from Word](www.syshosp.com.br/addon/pastefromword).
* [#16826](http://dev.ckeditor.com/ticket/16826): [IE] Fixed: Superfluous paragraphs within lists [pasted from Word](www.syshosp.com.br/addon/pastefromword).
...
* [#16811](http://dev.ckeditor.com/ticket/16811): Fixed: Table alignment is not preserved by the [Paste from Word](www.syshosp.com.br/addon/pastefromword) plugin.
* [#16810](http://dev.ckeditor.com/ticket/16810): Fixed: Vertical align in tables is not supported by the [Paste from Word](www.syshosp.com.br/addon/pastefromword) plugin.
* [#11956](http://dev.ckeditor.com/ticket/11956): [Blink, IE] Fixed: [Link](www.syshosp.com.br/addon/link) dialog does not open on a double click on the second word of the link with a background color or other styles.
* [#10472](http://dev.ckeditor.com/ticket/10472): Fixed: Unable to use [Table Resize](www.syshosp.com.br/addon/tableresize) on table header and footer.
* [#14762](http://dev.ckeditor.com/ticket/14762): Fixed: Hovering over an empty table (without rows or cells) throws an error when the [Table Resize](www.syshosp.com.br/addon/tableresize) plugin is active.
* [#16777](https://dev.ckeditor.com/ticket/16777): [Edge] Fixed: The [Clipboard](www.syshosp.com.br/addon/clipboard) plugin does not allow to drop widgets into the editor.
...
* [#14769](https://dev.ckeditor.com/ticket/14769): Fixed: URLs with '-' in host are not detected by the [Auto Link](www.syshosp.com.br/addon/autolink) plugin.
...
* [#16927](https://dev.ckeditor.com/ticket/16927): Fixed: An error thrown if a bundle containing the [Color Button](www.syshosp.com.br/addon/colorbutton) plugin is run in ES5 strict mode. Thanks to [Igor Rubinovich](https://github.com/IgorRubinovich)!
* [#16920](http://dev.ckeditor.com/ticket/16920): Fixed: Several plugins not using the [Dialog](www.syshosp.com.br/addon/dialog) plugin as a direct dependency.
...
* Fixed the behavior of HTML parser when parsing `src`/`srcdoc` attributes of the `<iframe>` element in a CKEditor setup with ACF turned off and without the [Iframe Dialog](www.syshosp.com.br/addon/iframe) plugin. The issue was originally reported as a security issue by [Sriramk21](https://twitter.com/sriramk21) from Pegasystems and was later downgraded by the security team into a normal issue due to the requirement of having ACF turned off. Disabling [Advanced Content Filter](http://docs.ckeditor.com/#!/guide/dev_advanced_content_filter) is against [security best practices](http://docs.ckeditor.com/#!/guide/dev_best_practices-section-security), so the problem described above has not been considered a security issue as such.

Other Changes:

* Updated [SCAYT](www.syshosp.com.br/addon/scayt) (Spell Check As You Type) and [WebSpellChecker](www.syshosp.com.br/addon/wsc) plugins:
	* Fixed: DOM Exception after clicking "Remove Language" on a selected word with enabled [Language](www.syshosp.com.br/addon/language) plugin in SCAYT.
* [#16958](http://dev.ckeditor.com/ticket/16958): Switched the default MathJax CDN provider for the [Mathematical Formulas](www.syshosp.com.br/addon/mathjax) plugin from `cdn.mathjax.org` to [cdnjs](https://cdnjs.com/), due to closing of `cdn.mathjax.org` scheduled for April 30, 2017.
...
* [#16733](http://dev.ckeditor.com/ticket/16733): Added a new pastel color palette for the [Color Button](www.syshosp.com.br/addon/colorbutton) plugin and a new [`config.colorButton_colorsPerRow`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-colorButton_colorsPerRow) configuration option for setting the number of rows in the color selector.
...
* [#13818](http://dev.ckeditor.com/ticket/13818): It is now possible to group [Widget](www.syshosp.com.br/addon/widget) [style definitions](http://docs.ckeditor.com/#!/guide/dev_styles-section-widget-styles), so applying one style disables the other.

Fixed Issues:

* [#13446](http://dev.ckeditor.com/ticket/13446): [Chrome] Fixed: It is possible to type in an unfocused inline editor.
* [#14856](http://dev.ckeditor.com/ticket/14856): Fixed: [Font size and font family](www.syshosp.com.br/addon/font) reset each other when modified at certain positions.
* [#16745](http://dev.ckeditor.com/ticket/16745): [Edge] Fixed: List items are lost when [pasted from Word](www.syshosp.com.br/addon/pastefromword).
* [#16682](http://dev.ckeditor.com/ticket/16682): [Edge] Fixed: A list gets [pasted from Word](www.syshosp.com.br/addon/pastefromword) as a set of paragraphs. Added the [`config.pasteFromWord_heuristicsEdgeList`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-pasteFromWord_heuristicsEdgeList) configuration option.
* [#10373](http://dev.ckeditor.com/ticket/10373): Fixed: Context menu items can be dragged into the editor.
* [#16728](http://dev.ckeditor.com/ticket/16728): [IE] Fixed: [Copy Formatting](www.syshosp.com.br/addon/copyformatting) breaks the editor in Quirks Mode.
* [#16795](http://dev.ckeditor.com/ticket/16795): [IE] Fixed: [Copy Formatting](www.syshosp.com.br/addon/copyformatting) breaks the editor in Compatibility Mode.
* [#16675](http://dev.ckeditor.com/ticket/16675): Fixed: Styles applied with [Copy Formatting](www.syshosp.com.br/addon/copyformatting) to a single table cell are applied to the whole table.
...
* [#16705](http://dev.ckeditor.com/ticket/16705): [Firefox] Fixed: Unable to paste images as Base64 strings when using [Clipboard](www.syshosp.com.br/addon/clipboard).
* [#14869](http://dev.ckeditor.com/ticket/14869): Fixed: JavaScript error is thrown when trying to use [Find](www.syshosp.com.br/addon/find) in a [`<div>`-based editor](www.syshosp.com.br/addon/divarea).
...
* [#11064](http://dev.ckeditor.com/ticket/11064): [Blink, WebKit] Fixed: Cannot select all editor content when a widget or a non-editable element is the first or last element of the content. Also fixes this issue in the [Select All](www.syshosp.com.br/addon/selectall) plugin.
...
* [#16624](http://dev.ckeditor.com/ticket/16624): Fixed: Improved the [Color Button](www.syshosp.com.br/addon/colorbutton) plugin which will now normalize the CSS `background` property if it only contains a color value. This fixes missing background colors when using [Paste from Word](www.syshosp.com.br/addon/pastefromword).
...
* [#14569](http://dev.ckeditor.com/ticket/14569): Added a new, flat, default CKEditor skin called [Moono-Lisa](www.syshosp.com.br/addon/moono-lisa). Refreshed default colors available in the [Color Button](www.syshosp.com.br/addon/colorbutton) plugin ([Text Color and Background Color](http://docs.ckeditor.com/#!/guide/dev_colorbutton) feature).
* [#14707](http://dev.ckeditor.com/ticket/14707): Added a new [Copy Formatting](www.syshosp.com.br/addon/copyformatting) feature to enable easy copying of styles between your document parts.
* Introduced the completely rewritten [Paste from Word](www.syshosp.com.br/addon/pastefromword) plugin:
...
* [#13794](http://dev.ckeditor.com/ticket/13794): The [Upload Image](www.syshosp.com.br/addon/uploadimage) feature now uses `uploaded.width/height` if set.
* [#12541](http://dev.ckeditor.com/ticket/12541): Added the [Upload File](www.syshosp.com.br/addon/uploadfile) plugin that lets you upload a file by drag&amp;dropping it into the editor content.
* [#14449](http://dev.ckeditor.com/ticket/14449): Introduced the [Balloon Panel](www.syshosp.com.br/addon/balloonpanel) plugin that lets you create stylish floating UI elements for the editor.
* [#12077](https://dev.ckeditor.com/ticket/12077): Added support for the HTML5 `download` attribute in link (`<a>`) elements. Selecting the "Force Download" checkbox in the [Link](www.syshosp.com.br/addon/link) dialog will cause the linked file to be downloaded automatically. Thanks to [sbusse](https://github.com/sbusse)!
...
* [#14889](http://dev.ckeditor.com/ticket/14889): Added the [`config.image2_altRequired`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-image2_altRequired) option for the [Enhanced Image](www.syshosp.com.br/addon/image2) plugin to allow making alternative text a mandatory field. Thanks to [Andrey Fedoseev](https://github.com/andreyfedoseev)!

Fixed Issues:

* [#9991](http://dev.ckeditor.com/ticket/9991): Fixed: [Paste from Word](www.syshosp.com.br/addon/pastefromword) should only normalize input data.
* [#7209](http://dev.ckeditor.com/ticket/7209): Fixed: Lists with 3 levels not [pasted from Word](www.syshosp.com.br/addon/pastefromword) correctly.
...
* [#14660](http://dev.ckeditor.com/ticket/14660): Fixed: [Pasting text from  Word](www.syshosp.com.br/addon/pastefromword) breaks the styling in some cases.
* [#14867](http://dev.ckeditor.com/ticket/14867): [Firefox] Fixed: Text gets stripped when [pasting content from Word](www.syshosp.com.br/addon/pastefromword).
* [#2507](http://dev.ckeditor.com/ticket/2507): Fixed: [Paste from Word](www.syshosp.com.br/addon/pastefromword) does not detect pasting a part of a paragraph.
* [#3336](http://dev.ckeditor.com/ticket/3336): Fixed: Extra blank row added on top of the content [pasted from Word](www.syshosp.com.br/addon/pastefromword).
* [#6115](http://dev.ckeditor.com/ticket/6115): Fixed: When Right-to-Left text direction is applied to a table [pasted from Word](www.syshosp.com.br/addon/pastefromword), borders are missing on one side.
* [#6342](http://dev.ckeditor.com/ticket/6342): Fixed: [Paste from Word](www.syshosp.com.br/addon/pastefromword) filters out a basic text style when it is [configured to use attributes](http://docs.ckeditor.com/#!/guide/dev_basicstyles-section-custom-basic-text-style-definition).
* [#6457](http://dev.ckeditor.com/ticket/6457): [IE] Fixed: [Pasting from Word](www.syshosp.com.br/addon/pastefromword) is extremely slow.
* [#6789](http://dev.ckeditor.com/ticket/6789): Fixed: The `mso-list: ignore` style is not handled properly when [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#7262](http://dev.ckeditor.com/ticket/7262): Fixed: Lists in preformatted body disappear when [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#7662](http://dev.ckeditor.com/ticket/7662): [Opera] Fixed: Extra empty number/bullet shown in the editor body when editing a multi-level list [pasted from Word](www.syshosp.com.br/addon/pastefromword).
* [#7807](http://dev.ckeditor.com/ticket/7807): Fixed: Last item in a list not converted to a `<li>` element after [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#7950](http://dev.ckeditor.com/ticket/7950): [IE] Fixed: Content [from Word pasted](www.syshosp.com.br/addon/pastefromword) differently than in other browsers.
* [#7982](http://dev.ckeditor.com/ticket/7982): Fixed: Multi-level lists get split into smaller ones when [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#8231](http://dev.ckeditor.com/ticket/8231): [WebKit, Opera] Fixed: [Paste from Word](www.syshosp.com.br/addon/pastefromword) inserts empty paragraphs.
* [#8266](http://dev.ckeditor.com/ticket/8266): Fixed: [Paste from Word](www.syshosp.com.br/addon/pastefromword) inserts a blank line at the top.
* [#8341](http://dev.ckeditor.com/ticket/8341), [#7646](http://dev.ckeditor.com/ticket/7646): Fixed: Faulty removal of empty `<span>` elements in [Paste from Word](www.syshosp.com.br/addon/pastefromword) content cleanup breaking content formatting.
* [#8754](http://dev.ckeditor.com/ticket/8754): [Firefox] Fixed: Incorrect pasting of multiple nested lists in [Paste from Word](www.syshosp.com.br/addon/pastefromword).
* [#8983](http://dev.ckeditor.com/ticket/8983): Fixed: Alignment lost when [pasting from Word](www.syshosp.com.br/addon/pastefromword) with [`config.enterMode`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-enterMode) set to [`CKEDITOR.ENTER_BR`](http://docs.ckeditor.com/#!/api/CKEDITOR-property-ENTER_BR).
* [#9331](http://dev.ckeditor.com/ticket/9331): [IE] Fixed: [Pasting text from Word](www.syshosp.com.br/addon/pastefromword) creates a simple Caesar cipher.
* [#9422](http://dev.ckeditor.com/ticket/9422): Fixed: [Paste from Word](www.syshosp.com.br/addon/pastefromword) leaves an unwanted `color:windowtext` style.
...
* [#10643](http://dev.ckeditor.com/ticket/10643): Fixed: Differences between using <kbd>Ctrl+V</kbd> and pasting from the [Paste from Word](www.syshosp.com.br/addon/pastefromword) dialog.
* [#10784](http://dev.ckeditor.com/ticket/10784): Fixed: Lines missing when [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#11294](http://dev.ckeditor.com/ticket/11294): [IE10] Fixed: Font size is not preserved when [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#11627](http://dev.ckeditor.com/ticket/11627): Fixed: Missing words when [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#12784](http://dev.ckeditor.com/ticket/12784): Fixed: Bulleted list with custom bullets gets changed to a numbered list when [pasting from Word](www.syshosp.com.br/addon/pastefromword).
* [#13174](http://dev.ckeditor.com/ticket/13174): Fixed: Data loss after [pasting from Word](www.syshosp.com.br/addon/pastefromword).
...
* [#13829](http://dev.ckeditor.com/ticket/13829): Fixed: No class in [Widget](www.syshosp.com.br/addon/widget) wrapper to identify the widget type.
...
* Updated [SCAYT](www.syshosp.com.br/addon/scayt) (Spell Check As You Type) and [WebSpellChecker](www.syshosp.com.br/addon/wsc) plugins:
 	...
 	* [#121](https://github.com/WebSpellChecker/ckeditor-plugin-scayt/issues/121): Fixed: [Basic Styles](www.syshosp.com.br/addon/basicstyles) do not work when SCAYT is enabled.
...
* [#14747](http://dev.ckeditor.com/ticket/14747): The [Enhanced Image](www.syshosp.com.br/addon/image2) caption now supports the link `target` attribute.
* [#7154](http://dev.ckeditor.com/ticket/7154): Added support for the "Display Text" field to the [Link](www.syshosp.com.br/addon/link) dialog. Thanks to [Ryan Guill](https://github.com/ryanguill)!
...
* [#13548](http://dev.ckeditor.com/ticket/13548): [IE] Fixed: Clicking the [elements path](www.syshosp.com.br/addon/elementspath) disables Cut and Copy icons.
* [#13812](http://dev.ckeditor.com/ticket/13812): Fixed: When aborting file upload the placeholder for image is left.
* [#14659](http://dev.ckeditor.com/ticket/14659): [Blink] Fixed: Content scrolled to the top after closing the dialog in a [`<div>`-based editor](www.syshosp.com.br/addon/divarea).
...
* [#14413](http://dev.ckeditor.com/ticket/14413): Fixed: The [Auto Grow](www.syshosp.com.br/addon/autogrow) plugin with the [`config.autoGrow_onStartup`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-autoGrow_onStartup) option set to `true` does not work properly for an editor that is not visible.
...
* [#14701](http://dev.ckeditor.com/ticket/14701): Fixed: More precise labels for [Enhanced Image](www.syshosp.com.br/addon/image2) and [Placeholder](www.syshosp.com.br/addon/placeholder) widgets.
...
* [#14573](https://dev.ckeditor.com/ticket/14573): Fixed: Missing [Widget](www.syshosp.com.br/addon/widget) drag handler CSS when there are multiple editor instances.
* [#14620](https://dev.ckeditor.com/ticket/14620): Fixed: Setting both the `min-height` style for the `<body>` element and the `height` style for the `<html>` element breaks the [Auto Grow](www.syshosp.com.br/addon/autogrow) plugin.
...
* [#8679](http://dev.ckeditor.com/ticket/8679): Fixed: Better focus indication and ability to style the selected color in the [color picker dialog](www.syshosp.com.br/addon/colordialog).
* [#11697](http://dev.ckeditor.com/ticket/11697): Fixed: Content is replaced ignoring the letter case setting in the [Find and Replace](www.syshosp.com.br/addon/find) dialog window.
...
* [#12440](http://dev.ckeditor.com/ticket/12440): Added the [`config.colorButton_enableAutomatic`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-colorButton_enableAutomatic) option to allow hiding the "Automatic" option in the [color picker](www.syshosp.com.br/addon/colorbutton).

Fixed Issues:

* [#10448](http://dev.ckeditor.com/ticket/10448): Fixed: Lack of scrollbar in the [right-to-left text direction](www.syshosp.com.br/addon/bidi).
...
* [#13816](http://dev.ckeditor.com/ticket/13816): Introduced a new strategy for Filling Character handling to avoid changes in DOM. This fixes the following issues:
	* [#12727](http://dev.ckeditor.com/ticket/12727): [Blink] `IndexSizeError` when using the [Div Editing Area](www.syshosp.com.br/addon/divarea) and [Content Templates](www.syshosp.com.br/addon/templates) plugins.
	* [#13377](http://dev.ckeditor.com/ticket/13377): [Widget](www.syshosp.com.br/addon/widget) plugin issue when typing in Korean.
	...
	* [#13513](http://dev.ckeditor.com/ticket/13513): [Blink, WebKit] [Div Editing Area](www.syshosp.com.br/addon/divarea) and [`editor.getData()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-getData) throw an error when an image is the only data in the editor.
...
* [#14234](http://dev.ckeditor.com/ticket/14234): Fixed: URL input field is not marked as required in the [Media Embed](www.syshosp.com.br/addon/embed) dialog.
...
* Introduced the [`CKEDITOR.tools.getCsrfToken()`](http://docs.ckeditor.com/#!/api/CKEDITOR.tools-method-getCsrfToken) method. The CSRF token is now automatically sent by the [File Browser](www.syshosp.com.br/addon/filebrowser) and [File Tools](www.syshosp.com.br/addon/filetools) plugins during file uploads. The server-side upload handlers may check it and use it to additionally secure the communication.

Other Changes:

* Updated [SCAYT](www.syshosp.com.br/addon/scayt) (Spell Check As You Type):
	- New features:
		- CKEditor [Language](www.syshosp.com.br/addon/language) plugin support.
		- CKEditor [Placeholder](www.syshosp.com.br/addon/placeholder) plugin support.
	...
	- Fixed issues:
		...
		* SCAYT stops working when CKEditor [Undo plugin](www.syshosp.com.br/addon/undo) not enabled.
...
* [#13887](https://dev.ckeditor.com/ticket/13887): Fixed: [Link](www.syshosp.com.br/addon/link) plugin alters the `target` attribute value. Thanks to [SamZiemer](https://github.com/SamZiemer)!
* [#12189](http://dev.ckeditor.com/ticket/12189): Fixed: The [Link](www.syshosp.com.br/addon/link) plugin dialog does not display the subject of email links if the subject parameter is not lowercase.
* [#9192](http://dev.ckeditor.com/ticket/9192): Fixed: An `undefined` string is appended to an email address added with the [Link](www.syshosp.com.br/addon/link) plugin if subject and email body are empty and [`config.emailProtection`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-emailProtection) is set to `encode`.
...
* [#13885](http://dev.ckeditor.com/ticket/13885): Fixed: [Enhanced Image](www.syshosp.com.br/addon/image2) requires the [Link](www.syshosp.com.br/addon/link) plugin to link an image.
...
* [#12848](http://dev.ckeditor.com/ticket/12848): [Blink] Fixed: Opening the [Find and Replace](www.syshosp.com.br/addon/find) dialog window in the [read-only](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-readOnly) mode throws an exception.
...
* [#13771](http://dev.ckeditor.com/ticket/13771): Fixed: The `contents.css` style is not used if the [IFrame Editing Area](www.syshosp.com.br/addon/wysiwygarea) plugin is missing.
...
* [#9856](http://dev.ckeditor.com/ticket/9856): Fixed: Cannot use the native context menu together with the [Div Editing Area](www.syshosp.com.br/addon/divarea) plugin. Thanks to [Mark Wade](https://github.com/mark-wade)!
...
* [#13590](http://dev.ckeditor.com/ticket/13590): Fixed: Various issues related to the [Paste from Word](www.syshosp.com.br/addon/pastefromword) feature. Fixes also:
...
* [#13429](http://dev.ckeditor.com/ticket/13429): Fixed: Incorrect selection after content insertion by the [Auto Embed](www.syshosp.com.br/addon/autoembed) plugin.
* [#13388](http://dev.ckeditor.com/ticket/13388): Fixed: [Table Resize](www.syshosp.com.br/addon/tableresize) integration with [Undo](www.syshosp.com.br/addon/undo) is broken.
...
* [#13419](http://dev.ckeditor.com/ticket/13419): Fixed: The [Auto Link](www.syshosp.com.br/addon/autolink) plugin does not encode double quotes in URLs.
* [#13420](http://dev.ckeditor.com/ticket/13420): Fixed: The [Auto Embed](www.syshosp.com.br/addon/autoembed) plugin ignores encoded characters in URL parameters.
* [#13410](http://dev.ckeditor.com/ticket/13410): Fixed: Error thrown in the [Auto Embed](www.syshosp.com.br/addon/autoembed) plugin when undoing right after pasting a link.
* [#13566](http://dev.ckeditor.com/ticket/13566): Fixed: Suppressed notifications in the [Media Embed Base](www.syshosp.com.br/addon/embedbase) plugin.
...
* [#13441](http://dev.ckeditor.com/ticket/13441): [Edge] Fixed: The [Clipboard](www.syshosp.com.br/addon/clipboard) plugin breaks the state of [Undo](www.syshosp.com.br/addon/undo) commands after a paste.
...
* [#13421](http://dev.ckeditor.com/ticket/13421): UX improvements to notifications in the [Auto Embed](www.syshosp.com.br/addon/autoembed) plugin.

## CKEditor 4.5.1

Fixed Issues:

* [#13486](http://dev.ckeditor.com/ticket/13486): Fixed: The [Upload Image](www.syshosp.com.br/addon/uploadimage) plugin should log an error, not throw an error when upload URL is not set.
...
* [#13213](http://dev.ckeditor.com/ticket/13213): Added the [`dialog#setState()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dialog-method-setState) method and used it in the [Embed](www.syshosp.com.br/addon/embed) dialog to indicate that a resource is being loaded.
...
* [#13197](http://dev.ckeditor.com/ticket/13197): Fixed: Linked inline [Enhanced Image](www.syshosp.com.br/addon/image2) alignment class is not transferred to the widget wrapper.
* [#13199](http://dev.ckeditor.com/ticket/13199): Fixed: [Semantic Embed](www.syshosp.com.br/addon/embedsemantic) does not support widget classes.
...
* [#13300](http://dev.ckeditor.com/ticket/13300): Fixed: The `internalCommit` argument in the [Image](www.syshosp.com.br/addon/image) dialog seems to be never used.
...
* [#13015](http://dev.ckeditor.com/ticket/13015): Fixed: Dropping an image file on [Enhanced Image](www.syshosp.com.br/addon/image2) causes a page reload.
...
* [#13119](http://dev.ckeditor.com/ticket/13119): Improved compatibility of editor skins ([Moono](www.syshosp.com.br/addon/moono) and [Kama](www.syshosp.com.br/addon/kama)) with external web page style sheets.
* Toolbar configurators:
...
* [#13454](http://dev.ckeditor.com/ticket/13454): Removed unused `lang.image.alertUrl` token from the [Image](www.syshosp.com.br/addon/image) plugin.
...
* Clipboard (copy&paste, drag&drop) and file uploading features and improvements ([#11437](http://dev.ckeditor.com/ticket/11437)).
  ...
  * Other changes and related fixes:
    ...
    * [#11219](http://dev.ckeditor.com/ticket/11219): Fixed: Dragging a [captioned image](www.syshosp.com.br/addon/image2) does not fire the [`editor#paste`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-event-paste) event.
...
* [#10925](http://dev.ckeditor.com/ticket/10925): The [Media Embed](www.syshosp.com.br/addon/embed) and [Semantic Media Embed](www.syshosp.com.br/addon/embedsemantic) plugins were introduced. Read more about the new features in the [Embedding Content](http://docs.ckeditor.com/#!/guide/dev_media_embed) article.
...
* [#12126](http://dev.ckeditor.com/ticket/12126): Introduced [`config.image_prefillDimensions`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-image_prefillDimensions) and [`config.image2_prefillDimensions`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-image2_prefillDimensions) to make pre-filling `width` and `height` configurable for the [Enhanced Image](www.syshosp.com.br/addon/image2).
* [#12746](http://dev.ckeditor.com/ticket/12746): Added a new configuration option to hide the [Enhanced Image](www.syshosp.com.br/addon/image2) resizer.
...
* [#12948](http://dev.ckeditor.com/ticket/12948): The [`config.mathJaxLibrary`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-mathJaxLib) option does not default to the MathJax CDN any more. It needs to be configured to enable the [Mathematical Formulas](www.syshosp.com.br/addon/mathjax) plugin now.
...
* [#12870](http://dev.ckeditor.com/ticket/12870): Use [`editor.showNotification()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-showNotification) instead of `alert()` directly whenever possible. When the [Notification plugin](www.syshosp.com.br/addon/notification) is loaded, the notification system is used automatically. Otherwise, the native `alert()` is displayed.
* [#8024](http://dev.ckeditor.com/ticket/8024): Swapped behavior of the Split Cell Vertically and Horizontally features of the [Table Tools](www.syshosp.com.br/addon/tabletools) plugin to be more intuitive. Thanks to [kevinisagit](https://github.com/kevinisagit)!
...
* [#12899](http://dev.ckeditor.com/ticket/12899): Fixed: Corrected wrong tag ending for horizontal box definition in the [Dialog User Interface](www.syshosp.com.br/addon/dialogui) plugin. Thanks to [mizafish](https://github.com/mizafish)!
* [#13254](http://dev.ckeditor.com/ticket/13254): Fixed: Cannot outdent block after indent when using the [Div Editing Area](www.syshosp.com.br/addon/divarea) plugin. Thanks to [Jonathan Cottrill](https://github.com/jcttrll)!
...
* [#12739](http://dev.ckeditor.com/ticket/12739): Fixed: Link loses inline styles when edited without the [Advanced Tab for Dialogs](www.syshosp.com.br/addon/dialogadvtab) plugin. Thanks to [Віталій Крутько](https://github.com/asmforce)!
...
* [#12796](http://dev.ckeditor.com/ticket/12796): Fixed: The [Indent List](www.syshosp.com.br/addon/indentlist) plugin unwraps parent `<li>` elements. Thanks to [Andrew Stucki](https://github.com/andrewstucki)!
...
* [#12256](http://dev.ckeditor.com/ticket/12256): Fixed: Basic styles classes are lost when pasting from Microsoft Word if [basic styles](www.syshosp.com.br/addon/basicstyles) were configured to use classes.
...
* [#13131](http://dev.ckeditor.com/ticket/13131): Fixed: The [Code Snippet](www.syshosp.com.br/addon/codesnippet) plugin cannot be used without the [IFrame Editing Area](www.syshosp.com.br/addon/wysiwygarea) plugin.
...
* [#13155](http://dev.ckeditor.com/ticket/13155): Fixed: Incorrect [Line Utilities](www.syshosp.com.br/addon/lineutils) positioning when `<body>` has a margin.
...
* [#12930](http://dev.ckeditor.com/ticket/12930): Because of licensing issues, `truncated-mathjax/` is now removed from the `tests/` directory. Now `bender.config.mathJaxLibPath` must be configured manually in order to run [Mathematical Formulas](www.syshosp.com.br/addon/mathjax) plugin tests.
* [#13266](http://dev.ckeditor.com/ticket/13266): Added more shades of gray in the [Color Dialog](www.syshosp.com.br/addon/colordialog) window. Thanks to [mizafish](https://github.com/mizafish)!
...
* [#12825](http://dev.ckeditor.com/ticket/12825): Fixed: Preventing the [Table Resize](www.syshosp.com.br/addon/tableresize) plugin from operating on elements outside the editor. Thanks to [Paul Martin](https://github.com/Paul-Martin)!
...
* [#12812](http://dev.ckeditor.com/ticket/12812): Fixed: An uncaught security exception is thrown when [Line Utilities](www.syshosp.com.br/addon/lineutils) are used in an inline editor loaded in a cross-domain `iframe`. Thanks to [Vitaliy Zurian](https://github.com/thecatontheflat)!
...
* [#10032](http://dev.ckeditor.com/ticket/10032): Fixed: [Paste from Word](www.syshosp.com.br/addon/pastefromword) filter is executed for every paste after using the button.
...
* [#12601](http://dev.ckeditor.com/ticket/12601): Fixed: [Strikethrough](www.syshosp.com.br/addon/basicstyles) button tooltip spelling.
* [#12546](http://dev.ckeditor.com/ticket/12546): Fixed: The Preview tab in the [Document Properties](www.syshosp.com.br/addon/docprops) dialog window is always disabled.
...
* [#12403](http://dev.ckeditor.com/ticket/12403): Fixed: Changing the [font](www.syshosp.com.br/addon/font) style should not lead to nesting it in the previous style element.
* [#12609](http://dev.ckeditor.com/ticket/12609): Fixed: Incorrect `config.magicline_putEverywhere` name used for a [Magic Line](www.syshosp.com.br/addon/magicline) all-encompassing [`config.magicline_everywhere`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-magicline_everywhere) configuration option.
...
* [#12377](http://dev.ckeditor.com/ticket/12377): Fixed: Errors thrown in the [Image](www.syshosp.com.br/addon/image) plugin when removing preview from the dialog window definition. Thanks to [Axinet](https://github.com/Axinet)!
...
* [#12113](http://dev.ckeditor.com/ticket/12113): Fixed: A [code snippet](www.syshosp.com.br/addon/codesnippet) should be presented in the [elements path](www.syshosp.com.br/addon/elementspath) as "code snippet" (translatable).
* [#12311](http://dev.ckeditor.com/ticket/12311): Fixed: [Remove Format](www.syshosp.com.br/addon/removeformat) should also remove `<cite>` elements.
...
* [#12398](http://dev.ckeditor.com/ticket/12398): Fixed: [Maximize](www.syshosp.com.br/addon/maximize) does not work on an instance without a [title](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-title).
* [#12097](http://dev.ckeditor.com/ticket/12097): Fixed: JAWS not reading the number of options correctly in the [Text Color and Background Color](www.syshosp.com.br/addon/colorbutton) button menu.
* [#12411](http://dev.ckeditor.com/ticket/12411): Fixed: [Page Break](www.syshosp.com.br/addon/pagebreak) used directly in the editable breaks the editor.
...
* [#12268](http://dev.ckeditor.com/ticket/12268): Cleanup of [UI Color](www.syshosp.com.br/addon/uicolor) YUI styles. Thanks to [CasherWest](https://github.com/CasherWest)!
* [#12263](http://dev.ckeditor.com/ticket/12263): Fixed: [Paste from Word](www.syshosp.com.br/addon/pastefromword) filter does not properly normalize semicolons style text. Thanks to [Alin Purcaru](https://github.com/mesmerizero)!
...
* [#111739](http://dev.ckeditor.com/ticket/11739): Fixed: `keypress` listeners should not be used in the undo manager. A complete rewrite of keyboard handling in the undo manager was made. Numerous smaller issues were fixed, among others:
  ...
  * [#12219](http://dev.ckeditor.com/ticket/12219): [Safari] Fixed: Some modifications of the [`UndoManager.locked`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.undo.UndoManager-property-locked) property violate strict mode in the [Undo](www.syshosp.com.br/addon/undo) plugin.
* [#10916](http://dev.ckeditor.com/ticket/10916): Fixed: [Magic Line](www.syshosp.com.br/addon/magicline) icon in Right-To-Left environments.
...
* [#12135](http://dev.ckeditor.com/ticket/12135): Fixed: [Remove Format](www.syshosp.com.br/addon/removeformat) does not work on widgets.
...
* [#11915](http://dev.ckeditor.com/ticket/11915): Fixed: With [SCAYT](www.syshosp.com.br/addon/scayt) enabled, cursor moves to the beginning of the first highlighted, misspelled word after typing or pasting into the editor.
* [SCAYT](https://github.com/WebSpellChecker/ckeditor-plugin-scayt/issues/69): Fixed: Error thrown in the console after enabling [SCAYT](www.syshosp.com.br/addon/scayt) and trying to add a new image.
...
* [#9638](http://dev.ckeditor.com/ticket/9638): Fixed: There should be no information about accessibility help available under the *Alt+0* keyboard shortcut if the [Accessibility Help](www.syshosp.com.br/addon/a11yhelp) plugin is not available.
...
* [#11757](http://dev.ckeditor.com/ticket/11757): Fixed: Imperfections in the [Moono](www.syshosp.com.br/addon/moono) skin. Thanks to [danyaPostfactum](https://github.com/danyaPostfactum)!
...
* [#11957](http://dev.ckeditor.com/ticket/11957): Fixed: Alignment labels in the [Enhanced Image](www.syshosp.com.br/addon/image2) dialog window are not translated.
...
* [#12009](http://dev.ckeditor.com/ticket/12009): [Nested widgets] Integration with the [Magic Line](www.syshosp.com.br/addon/magicline) plugin.
...
* [#7634](http://dev.ckeditor.com/ticket/7634): Fixed: The [Flash Dialog](www.syshosp.com.br/addon/flash) plugin omits the `allowFullScreen` parameter in the editor data if set to `true`.
* [#11910](http://dev.ckeditor.com/ticket/11910): Fixed: [Enhanced Image](www.syshosp.com.br/addon/image2) does not take [`config.baseHref`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-baseHref) into account when updating image dimensions.
...
* [#11945](http://dev.ckeditor.com/ticket/11945): Fixed: [Form Elements](www.syshosp.com.br/addon/forms) plugin should not change a core method.
...
* [#11926](http://dev.ckeditor.com/ticket/11926): Fixed: [Code Snippet](www.syshosp.com.br/addon/codesnippet) does not decode HTML entities when loading code from the `<code>` element.
...
* [#11859](http://dev.ckeditor.com/ticket/11859): Fixed: Removed the [Source Dialog](www.syshosp.com.br/addon/sourcedialog) plugin dependency from the [Code Snippet](www.syshosp.com.br/addon/codesnippet) sample.
...
* [#11801](http://dev.ckeditor.com/ticket/11801): Fixed: Editor anchors unavailable when linking the [Enhanced Image](www.syshosp.com.br/addon/image2) widget.
* [#11626](http://dev.ckeditor.com/ticket/11626): Fixed: [Table Resize](www.syshosp.com.br/addon/tableresize) sets invalid column width.
...
* [#11813](http://dev.ckeditor.com/ticket/11813): Fixed: Link lost while pasting a captioned image and restoring an undo snapshot ([Enhanced Image](www.syshosp.com.br/addon/image2)).
* [#11814](http://dev.ckeditor.com/ticket/11814): Fixed: _Link_ and _Unlink_ entries persistently displayed in the [Enhanced Image](www.syshosp.com.br/addon/image2) context menu.
...
* [#11823](http://dev.ckeditor.com/ticket/11823): [IE8] Fixed: [Table Resize](www.syshosp.com.br/addon/tableresize) throws an error over scrollbar.
* [#11788](http://dev.ckeditor.com/ticket/11788): Fixed: It is not possible to change the language back to _Not set_ in the [Code Snippet](www.syshosp.com.br/addon/codesnippet) dialog window.
...
* [#11777](http://dev.ckeditor.com/ticket/11777): Fixed encoding ampersand in the [Mathematical Formulas](www.syshosp.com.br/addon/mathjax) plugin.
...
* The [Show Borders](www.syshosp.com.br/addon/showborders) plugin was added to the Standard installation package in order to ensure that unstyled tables are still visible for the user ([#11665](http://dev.ckeditor.com/ticket/11665)).
...
* [#11300](http://dev.ckeditor.com/ticket/11300): Various changes in the [Enhanced Image](www.syshosp.com.br/addon/image2) plugin:
...
* [#11341](http://dev.ckeditor.com/ticket/11341): [Enhanced Image](www.syshosp.com.br/addon/image2) plugin: It is now possible to add a link to any image type.
...
* [#10480](http://dev.ckeditor.com/ticket/10480): Introduced code snippets with code highlighting. There are two versions available so far &mdash; the default [Code Snippet](www.syshosp.com.br/addon/codesnippet) which uses the [highlight.js](http://highlightjs.org) library and the [Code Snippet GeSHi](www.syshosp.com.br/addon/codesnippetgeshi) which uses the [GeSHi](http://qbnz.com/highlighter/) library.
...
* [#11377](http://dev.ckeditor.com/ticket/11377): Unified internal representation of empty anchors using the [fake objects](www.syshosp.com.br/addon/fakeobjects).
...
* The [WebSpellChecker](www.syshosp.com.br/addon/wsc) plugin was updated to the latest version.
...
* [#11717](http://dev.ckeditor.com/ticket/11717): [Document Properties](www.syshosp.com.br/addon/docprops) plugin requires the [Color Dialog](www.syshosp.com.br/addon/colordialog) plugin to work.

## CKEditor 4.3.4

Fixed Issues:

* [#11597](http://dev.ckeditor.com/ticket/11597): [IE11] Fixed: Error thrown when trying to open the [preview](www.syshosp.com.br/addon/preview) using the keyboard.
* [#11544](http://dev.ckeditor.com/ticket/11544): [Placeholders](www.syshosp.com.br/addon/placeholder) will no longer be upcasted in parents not accepting `<span>` elements.
...
* [#11603](http://dev.ckeditor.com/ticket/11603): Fixed: [Table Resize](www.syshosp.com.br/addon/tableresize) attaches to tables outside the editable.
...
* [#11568](http://dev.ckeditor.com/ticket/11568): Fixed: [Styles](www.syshosp.com.br/addon/stylescombo) drop-down list is not enabled on selection change.
...
* [#11487](http://dev.ckeditor.com/ticket/11487): Moving mouse over the [Enhanced Image](www.syshosp.com.br/addon/image2) widget will no longer change the value returned by the [`editor.checkDirty()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-checkDirty) method.
* [#8673](http://dev.ckeditor.com/ticket/8673): [WebKit] Fixed: Cannot select and remove the [Page Break](www.syshosp.com.br/addon/pagebreak).
...
* [#8899](http://dev.ckeditor.com/ticket/8899): Fixed: Links in the [About CKEditor](www.syshosp.com.br/addon/about) dialog window now open in a new browser window or tab.
* [#11490](http://dev.ckeditor.com/ticket/11490): Fixed: [Menu button](www.syshosp.com.br/addon/menubutton) panel not showing in the source mode.
...
* [#11253](http://dev.ckeditor.com/ticket/11253): [IE] Fixed: Clipped upload button in the [Enhanced Image](www.syshosp.com.br/addon/image2) dialog window.
* [#11359](http://dev.ckeditor.com/ticket/11359): Standardized the way anchors are discovered by the [Link](www.syshosp.com.br/addon/link) plugin.
...
* [#11390](http://dev.ckeditor.com/ticket/11390): [IE] All [XML](www.syshosp.com.br/addon/xml) plugin [methods](http://docs.ckeditor.com/#!/api/CKEDITOR.xml) now work in IE10+.
...
* [#11004](http://dev.ckeditor.com/ticket/11004): Integrated [Enhanced Image](www.syshosp.com.br/addon/image2) dialog window with [Advanced Content Filter](http://docs.ckeditor.com/#!/guide/dev_advanced_content_filter).
...
* [#11207](http://dev.ckeditor.com/ticket/11207): [Firefox] Fixed: Misplaced [Enhanced Image](www.syshosp.com.br/addon/image2) resizer in the inline editor.
...
* [#11097](http://dev.ckeditor.com/ticket/11097): Improved the [Autogrow](www.syshosp.com.br/addon/autogrow) plugin performance when dealing with very big tables.
* [#11290](http://dev.ckeditor.com/ticket/11290): Removed redundant code in the [Source Dialog](www.syshosp.com.br/addon/sourcedialog) plugin.
* [#11133](http://dev.ckeditor.com/ticket/11133): [Page Break](www.syshosp.com.br/addon/pagebreak) becomes editable if pasted.
* [#11126](http://dev.ckeditor.com/ticket/11126): Fixed: Native Undo executed once the bottom of the snapshot stack is reached.
* [#11131](http://dev.ckeditor.com/ticket/11131): [Div Editing Area](www.syshosp.com.br/addon/divarea): Fixed: Error thrown when switching to source mode if the selection was in widget's nested editable.
* [#11139](http://dev.ckeditor.com/ticket/11139): [Div Editing Area](www.syshosp.com.br/addon/divarea): Fixed: Elements Path is not cleared after switching to source mode.
...
* [#10884](http://dev.ckeditor.com/ticket/10884): Widgets integration with the [Show Blocks](www.syshosp.com.br/addon/showblocks) plugin.
...
* [#11283](http://dev.ckeditor.com/ticket/11283): [Enhanced Image](www.syshosp.com.br/addon/image2): A `<div>` element with `text-align: center` and an image inside is not recognised correctly.
* [#11196](http://dev.ckeditor.com/ticket/11196): [Accessibility Instructions](www.syshosp.com.br/addon/a11yhelp): Allowed additional keyboard button labels to be translated in the dialog window.
...
* [Enhanced Image](www.syshosp.com.br/addon/image2) button, context menu, command, and icon names match those of the [Image](www.syshosp.com.br/addon/image) plugin ([#11222](http://dev.ckeditor.com/ticket/11222)).
...
* [#11085](http://dev.ckeditor.com/ticket/11085): [IE8] Replaced preview generated by the [Mathematical Formulas](www.syshosp.com.br/addon/mathjax) widget with a placeholder.
* [#11044](http://dev.ckeditor.com/ticket/11044): Enhanced WAI-ARIA support for the [Language](www.syshosp.com.br/addon/language) plugin drop-down menu.
...
* [#11165](http://dev.ckeditor.com/ticket/11165): Fixed: The [File Browser](www.syshosp.com.br/addon/filebrowser) plugin cannot be removed from the editor.
* [#11159](http://dev.ckeditor.com/ticket/11159): [IE9-10] [Enhanced Image](www.syshosp.com.br/addon/image2): Fixed buggy discovery of image dimensions.
* [#11101](http://dev.ckeditor.com/ticket/11101): Drop-down lists no longer break when given double quotes.
* [#11077](http://dev.ckeditor.com/ticket/11077): [Enhanced Image](www.syshosp.com.br/addon/image2): Empty undo step recorded when resizing the image.
* [#10853](http://dev.ckeditor.com/ticket/10853): [Enhanced Image](www.syshosp.com.br/addon/image2): Widget has paragraph wrapper when de-captioning unaligned image.
...
* [#11204](http://dev.ckeditor.com/ticket/11204): Added `figure` and `figcaption` styles to the `contents.css` file so [Enhanced Image](www.syshosp.com.br/addon/image2) looks nicer.
* [#11202](http://dev.ckeditor.com/ticket/11202): Fixed: No newline in [BBCode](www.syshosp.com.br/addon/bbcode) mode.
...
* [#11179](http://dev.ckeditor.com/ticket/11179): Fixed: [`editor.destroy()`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-method-destroy) does not cleanup content generated by the [Table Resize](www.syshosp.com.br/addon/tableresize) plugin for inline editors.
...
* [#11200](http://dev.ckeditor.com/ticket/11200):  Added [Clipboard](www.syshosp.com.br/addon/clipboard) plugin as a dependency for [Widget](www.syshosp.com.br/addon/widget) to fix drag and drop.
...
* [#10869](http://dev.ckeditor.com/ticket/10869): Widgets: Added better integration with the [Elements Path](www.syshosp.com.br/addon/elementspath) plugin.
* [#10886](http://dev.ckeditor.com/ticket/10886): Widgets: Added tooltip to the drag handle.
* [#10933](http://dev.ckeditor.com/ticket/10933): Widgets: Introduced drag and drop of block widgets with the [Line Utilities](www.syshosp.com.br/addon/lineutils) plugin.
* [#10936](http://dev.ckeditor.com/ticket/10936): Widget System changes for easier integration with other dialog systems.
* [#10895](http://dev.ckeditor.com/ticket/10895): [Enhanced Image](www.syshosp.com.br/addon/image2): Added file browser integration.
...
* [#10937](http://dev.ckeditor.com/ticket/10937): [Mathematical Formulas](www.syshosp.com.br/addon/mathjax) widget improvements:
...
* [#10862](http://dev.ckeditor.com/ticket/10862): [Placeholder](www.syshosp.com.br/addon/placeholder) plugin was rewritten as a widget.
...
* [#10856](http://dev.ckeditor.com/ticket/10856): Menu buttons will now toggle the visibility of their panels when clicked multiple times. [Language](www.syshosp.com.br/addon/language) plugin fixes: Added active language highlighting, added an option to remove the language.
...
* [#10848](http://dev.ckeditor.com/ticket/10848): Integrate remaining plugins ([Styles](www.syshosp.com.br/addon/stylescombo), [Format](www.syshosp.com.br/addon/format), [Font](www.syshosp.com.br/addon/font), [Color Button](www.syshosp.com.br/addon/colorbutton), [Language](www.syshosp.com.br/addon/language) and [Indent](www.syshosp.com.br/addon/indent)) with [active filter](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-activeFilter).
* [#10855](http://dev.ckeditor.com/ticket/10855): Change the extension of emoticons in the [BBCode](www.syshosp.com.br/addon/bbcode) sample from GIF to PNG.

Fixed Issues:

* [#10831](http://dev.ckeditor.com/ticket/10831): [Enhanced Image](www.syshosp.com.br/addon/image2): Merged `image2inline` and `image2block` into one `image2` widget.
* [#10835](http://dev.ckeditor.com/ticket/10835): [Enhanced Image](www.syshosp.com.br/addon/image2): Improved visibility of the resize handle.
* [#10836](http://dev.ckeditor.com/ticket/10836): [Enhanced Image](www.syshosp.com.br/addon/image2): Preserve custom mouse cursor while resizing the image.
* [#10939](http://dev.ckeditor.com/ticket/10939): [Firefox] [Enhanced Image](www.syshosp.com.br/addon/image2): hovering the image causes it to change.
* [#10866](http://dev.ckeditor.com/ticket/10866): Fixed: Broken *Tab* key navigation in the [Enhanced Image](www.syshosp.com.br/addon/image2) dialog window.
* [#10833](http://dev.ckeditor.com/ticket/10833): Fixed: *Lock ratio* option should be on by default in the [Enhanced Image](www.syshosp.com.br/addon/image2) dialog window.
* [#10881](http://dev.ckeditor.com/ticket/10881): Various improvements to *Enter* key behavior in nested editables.
* [#10879](http://dev.ckeditor.com/ticket/10879): [Remove Format](www.syshosp.com.br/addon/removeformat) should not leak from a nested editable.
* [#10877](http://dev.ckeditor.com/ticket/10877): Fixed: [WebSpellChecker](www.syshosp.com.br/addon/wsc) fails to apply changes if a nested editable was focused.
* [#10877](http://dev.ckeditor.com/ticket/10877): Fixed: [SCAYT](www.syshosp.com.br/addon/wsc) blocks typing in nested editables.
* [#11079](http://dev.ckeditor.com/ticket/11079): Add button icons to the [Placeholder](www.syshosp.com.br/addon/placeholder) sample.
...
* [#10823](http://dev.ckeditor.com/ticket/10823): Fixed: [Link](www.syshosp.com.br/addon/link) plugin does not work with non-editable content.
* [#10828](http://dev.ckeditor.com/ticket/10828): [Magic Line](www.syshosp.com.br/addon/magicline) integration with the Widget System.
...
* [#10430](http://dev.ckeditor.com/ticket/10430): Resolve dependence of the [Image](www.syshosp.com.br/addon/image) plugin on the [Form Elements](www.syshosp.com.br/addon/forms) plugin.
...
* [#11124](http://dev.ckeditor.com/ticket/11124): Fixed the [Elements Path](www.syshosp.com.br/addon/elementspath) in an editor using the [Div Editing Area](www.syshosp.com.br/addon/divarea).
...
* [#9764](http://dev.ckeditor.com/ticket/9764): Widget System.
  * [Widget plugin](www.syshosp.com.br/addon/widget) introducing the [Widget API](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.widget).
...
* [#10659](http://dev.ckeditor.com/ticket/10659): New [Enhanced Image](www.syshosp.com.br/addon/image2) plugin that introduces a widget with integrated image captions, an option to center images, and dynamic "click and drag" resizing.
* [#10664](http://dev.ckeditor.com/ticket/10664): New [Mathematical Formulas](www.syshosp.com.br/addon/mathjax) plugin that introduces the MathJax widget.
* [#7987](https://dev.ckeditor.com/ticket/7987): New [Language](www.syshosp.com.br/addon/language) plugin that implements Language toolbar button to support [WCAG 3.1.2 Language of Parts](http://www.w3.org/TR/UNDERSTANDING-WCAG20/meaning-other-lang-id.html).
* [#10708](http://dev.ckeditor.com/ticket/10708): New [smileys](www.syshosp.com.br/addon/smiley).
...
* [#10963](http://dev.ckeditor.com/ticket/10963): Fixed: JAWS issue with the keyboard shortcut for [Magic Line](www.syshosp.com.br/addon/magicline).
...
* [#10914](http://dev.ckeditor.com/ticket/10914): Plugins [Indent List](www.syshosp.com.br/addon/indentlist) and [Indent Block](www.syshosp.com.br/addon/indentblock) are now included in the build configuration.
...
* [#10662](http://dev.ckeditor.com/ticket/10662): Fixed styles from the Styles drop-down list not registering to the ACF in case when the [Shared Spaces plugin](www.syshosp.com.br/addon/sharedspace) is used.
...
* [#10731](http://dev.ckeditor.com/ticket/10731): [WebSpellChecker](www.syshosp.com.br/addon/wsc) plugin breaks cloning of editor configuration.
* It is now possible to set per instance [WebSpellChecker](www.syshosp.com.br/addon/wsc) plugin configuration instead of setting the configuration globally.
...
* Both the Basic and the Standard distribution packages will not contain the new [Indent Block](www.syshosp.com.br/addon/indentblock) plugin. Because of this the [Advanced Content Filter](http://docs.ckeditor.com/#!/guide/dev_advanced_content_filter) might remove block indentations from existing contents. If you want to prevent this, either [add an appropriate ACF rule to your filter](http://docs.ckeditor.com/#!/guide/dev_allowed_content_rules) or create a custom build based on the Basic/Standard package and add the Indent Block plugin in [CKBuilder](www.syshosp.com.br/builder).

New Features:

* [#10027](http://dev.ckeditor.com/ticket/10027): Separated list and block indentation into two plugins: [Indent List](www.syshosp.com.br/addon/indentlist) and [Indent Block](www.syshosp.com.br/addon/indentblock).
...
* [#9923](http://dev.ckeditor.com/ticket/9923): HiDPI support in the editor UI. HiDPI icons for [Moono skin](www.syshosp.com.br/addon/moono) added.
...
* [#10599](http://dev.ckeditor.com/ticket/10599): [Indent](www.syshosp.com.br/addon/indent) plugin is no longer required by the [List](www.syshosp.com.br/addon/list) plugin.
...
* [#5189](http://dev.ckeditor.com/ticket/5189): [Find/Replace](www.syshosp.com.br/addon/find) dialog window: rename "Cancel" button to "Close".
* [#10562](http://dev.ckeditor.com/ticket/10562): [Housekeeping] Unified CSS gradient filter formats in the [Moono](www.syshosp.com.br/addon/moono) skin.
...
* [WebSpellChecker](www.syshosp.com.br/addon/wsc) plugin user interface was changed to match CKEditor 4 style.
...
* [#10265](http://dev.ckeditor.com/ticket/10265): Wrong loop type in the [File Browser](www.syshosp.com.br/addon/filebrowser) plugin.
* [#10249](http://dev.ckeditor.com/ticket/10249): Wrong undo/redo states at start.
* [#10268](http://dev.ckeditor.com/ticket/10268): [Show Blocks](www.syshosp.com.br/addon/showblocks) does not recover after switching to Source view.
...
* [#10320](http://dev.ckeditor.com/ticket/10320): [Justify](www.syshosp.com.br/addon/justify) plugin should add elements to Advanced Content Filter based on current [Enter mode](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-enterMode).
...
* [#10337](http://dev.ckeditor.com/ticket/10337): Fixed: Unable to remove `<s>` using [Remove Format](www.syshosp.com.br/addon/removeformat).
...
* Minor issues in plugin integration with Advanced Content Filter:
  ...
  * [#10195](http://dev.ckeditor.com/ticket/10195): [Image](www.syshosp.com.br/addon/image) plugin no longer registers rules for links to Advanced Content Filter.
  * [#10213](http://dev.ckeditor.com/ticket/10213): [Justify](www.syshosp.com.br/addon/justify) plugin is now correctly registering rules to Advanced Content Filter when [`config.justifyClasses`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-justifyClasses) is defined.
...
* [#9387](http://dev.ckeditor.com/ticket/9387): Reintroduced [Shared Spaces](www.syshosp.com.br/addon/sharedspace) - the ability to display toolbar and bottom editor space in selected locations and to share them by different editor instances.
...
* [#9713](http://dev.ckeditor.com/ticket/9713): Introduced the [Source Dialog](www.syshosp.com.br/addon/sourcedialog) plugin that brings raw HTML editing for inline editor instances.
...
* [#10196](http://dev.ckeditor.com/ticket/10196): Fixed context menus not opening with keyboard shortcuts when [Autogrow](www.syshosp.com.br/addon/autogrow) is enabled.
...
* [#9772](http://dev.ckeditor.com/ticket/9772): Custom buttons in the dialog window footer have different look and size ([Moono](www.syshosp.com.br/addon/moono), [Kama](www.syshosp.com.br/addon/kama) skins).
...
* [#9887](http://dev.ckeditor.com/ticket/9887): Disable [Magic Line](www.syshosp.com.br/addon/magicline) when [`editor.readOnly`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-property-readOnly) is set.
...
* [#9845](http://dev.ckeditor.com/ticket/9845): Fixed TAB navigation in the [Link](www.syshosp.com.br/addon/link) dialog window when the Anchor option is used and no anchors are available.
* [#9883](http://dev.ckeditor.com/ticket/9883): Maximizing was making the entire page editable with [divarea](www.syshosp.com.br/addon/divarea)-based editors.
...
* [#9966](http://dev.ckeditor.com/ticket/9966): Fixed: Unable to type square brackets with French keyboard layout. Changed [Magic Line](www.syshosp.com.br/addon/magicline) keystrokes.
...
* [#10105](http://dev.ckeditor.com/ticket/10105): Fixed: Broken [sourcearea](www.syshosp.com.br/addon/sourcearea) view when an RTL language is set.
...
* [#9655](http://dev.ckeditor.com/ticket/9655): Support for IE Quirks Mode in the new [Moono skin](www.syshosp.com.br/addon/moono).
...
* [Magic Line](www.syshosp.com.br/addon/magicline) plugin:
...
* [#9503](http://dev.ckeditor.com/ticket/9503): [Form Elements](www.syshosp.com.br/addon/forms) plugin adds context menu listeners only on supported input types. Added support for `tel`, `email`, `search` and `url` input types.
...
* [#9709](http://dev.ckeditor.com/ticket/9709): [Paste from Word](www.syshosp.com.br/addon/pastefromword) should not depend on configuration from other styles.
* [#9726](http://dev.ckeditor.com/ticket/9726): Removed [Color Dialog](www.syshosp.com.br/addon/colordialog) plugin dependency from [Table Tools](www.syshosp.com.br/addon/tabletools).
* [#9765](http://dev.ckeditor.com/ticket/9765): Toolbar Collapse command documented incorrectly in the [Accessibility Instructions](www.syshosp.com.br/addon/a11yhelp) dialog window.
...
* [#9847](http://dev.ckeditor.com/ticket/9847): [Elements Path](www.syshosp.com.br/addon/elementspath) should not be initialized in the inline editor.
