...
{ 
location.href="prioridade.php?ATITUDE=" + indice;
} 
...
<?php
$ACESSO=""; 
$ACESSO="CADASTRO DE PRIORIDADES "; 
include "conexao.php";
include "controleacesso.php";
$SQL="SELECT CODIGO, DESCRICAO, SLA FROM PRIORIDADE "; 
			...
			<div class="modal-content">   
			  <div class="modal-header" style="background-image: linear-gradient(to right top, #504a55, #48444d, #403d46, #39373e, #323137); color: white; font-weight: bold; font-size: 70px;">   
				...
				<button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
			  	...
			  	<form method="post" action="prioridade_dados.php">    
				  <div class="modal-body">  
					...
					<div class="row">
						...
						<div class="col-md-2">
							<label>SLA</label>
							<?PHP if (!empty($_GET["ATITUDE"])) {?>
								<input type="text" name="SLA" autofocus value="<?php echo $row["SLA"]?>" id="SLA" class="form-control">
							<?PHP }else{ ?>
								<input type="text" name="SLA" autofocus id="SLA" class="form-control">
							<?PHP } ?>
						</div>
					</div> 
				  </div> 
				  <div class="modal-footer"> 
					<button type="button" class="btn btn-danger" data-dismiss="modal" onclick='location.href="prioridade.php?GRUPO=<?php ECHO $_GET["GRUPO"]?>"'>Fechar</button> 
