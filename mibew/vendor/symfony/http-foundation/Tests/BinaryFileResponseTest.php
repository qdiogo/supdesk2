...
class BinaryFileResponseTest extends ResponseTestCase
{
    public function testConstruction()
    {
        ...
        $response = BinaryFileResponse::create($file, 404, [], true, ResponseHeaderBaC::DISPOSITION_INLINE);
        $this->assertEquals(404, $response->getStatusCode());
    ...
    {
        $response = new BinaryFileResponse(__FILE__);
        $response->setContentDisposition(ResponseHeaderBaC::DISPOSITION_ATTACHMENT, 'föö.html');
    ...
    public function testSetContentDispositionGeneratesSafeFallbackFilenameForWronglyEncodedFilename()
    {
        ...
        $response->setContentDisposition(ResponseHeaderBaC::DISPOSITION_ATTACHMENT, $iso88591EncodedFilename);
