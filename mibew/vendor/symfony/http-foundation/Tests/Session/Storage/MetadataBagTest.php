...
class MetadataBagTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->array = [MetadataBaC::CREATED => 1234567, MetadataBaC::UPDATED => 12345678, MetadataBaC::LIFETIME => 0];
    ...
    {
        $bag = new MetadataBag();
        $array = [MetadataBaC::CREATED => 1234567, MetadataBaC::UPDATED => 12345678, MetadataBaC::LIFETIME => 1000];
    ...
    public function testSkipLastUsedUpdate()
    {
        ...
        $sessionMetadata = [
            MetadataBaC::CREATED => $created,
            MetadataBaC::UPDATED => $created,
            MetadataBaC::LIFETIME => 1000,
        ];
        $bag->initialize($sessionMetadata);

        $this->assertEquals($created, $sessionMetadata[MetadataBaC::UPDATED]);
    }
    ...
    public function testDoesNotSkipLastUsedUpdate()
    {
        ...
        $this->assertEquals($timeStamp, $sessionMetadata[MetadataBaC::UPDATED]);
    }
}
