    ...
    e.Views.QueuedThread = e.Views.CompositeBase.extend({
        ...
        serializeData: function() {
            var t = this.model,
                ...
                a = t.toJSON();
            return a.stateDesc = this.stateToDesc(t.get("state")), a.chatting = t.get("state") == t.STATE_CHATTING, a.tracked = i.get("showVisitors"), a.firstMessage && (a.firstMessagePreview = a.firstMessage.length > 30 ? a.firstMessage.substring(0, 30) + "..." : a.firstMessage), a
        },
        ...
        showDialogWindow: function(t) {
            ...
            e.Popup.open(s.get("agentLink") + "/" + a + (t ? "?viewonly=true" : ""), "ImCenter" + a, e.Utils.buildWindowParams(s.get("chatWindowParams")))
        },
        showTrack: function() {
            var t = this.model.id,
                i = e.Objects.Models.page;
        ...
        showBan: function() {
            var t = this.model,
                i = t.get("ban"),
                a = e.Objects.Models.page;
            e.Popup.open(a.get("banLink") + "/" + (i !== !1 ? i.id + "/edit" : "add?thread=" + t.id), "ImBan" + i.id, e.Utils.buildWindowParams(a.get("banWindowParams")))
        },
