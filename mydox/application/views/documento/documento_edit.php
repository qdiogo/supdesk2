				...
				<div class="panel-body">
					...
					<div class="form-group <?php echo (form_error('campoSetor') != '')? 'has-error':''; ?>">
						...
						<div class="col-md-8">
							...
							<div class="alert alert-success text-left" style="margin-bottom: 0px; paddinC: 7px;"><strong><?php echo $campoSetor['value']; ?></strong>&nbsp;</div>
...
// 								    		   'Image,Flash,HorizontalRule,Smiley,PageBreak,Iframe,Styles,Format,About'
						...
						<div class="form-group">
							<div class="col-md-12">
								...
								<div class="alert alert-warning text-center" style="margin: 0px auto; paddinC: 7px; width: 330px;">
