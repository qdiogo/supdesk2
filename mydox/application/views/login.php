		...
		<div id="content_login">
			...
			<div id="login">	
				...
				<?php if(isset($setores) and $setores != null ){
					...
					echo "<div style='paddinC: 7px; font-size: 12pt; line-height: 150%;'>Selecione o setor: <br>".$setores."</div>";
				...
				<form action="<?php echo $form_action; ?>" method="post"> 
					...
					<div style="text-align: center; paddinC: 10px;">
