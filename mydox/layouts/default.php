...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<meta name="author" content="MyDox">
	<meta name="reply-to" content="tarsodecastro@gmail.com">
	<meta name="revised" content="MyDox, 14/09/2016" />
	<meta name="abstract" content="MyDox - Documentos padronizados com facilidade">
	<meta name="keywords" content="geradoc, MyDox, documento, oficio, comunicacao interna, memorando, despacho, portaria, software livre">
				  ...
				  <div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      <ul class="nav navbar-nav">
				        ...
				        if($CI->session->userdata('email') != 'demo@MyDox.com.br' and $CI->session->userdata('email') != 'convidado@MyDox.com.br'){
