...
{ 
location.href="ACAOX.php?ATITUDE=" + indice;
} 
...
<?php
$ACESSO=""; 
$ACESSO="CADASTRO DE ACAO"; 
include "conexao.php";
include "controleacesso.php";
$SQL="SELECT CODIGO,NOME FROM ACAO"; 
			...
			<div class="modal-content">   
			  <div class="modal-header" style="background-image: linear-gradient(to right top, #504a55, #48444d, #403d46, #39373e, #323137); color: white; font-weight: bold; font-size: 70px;">   
				...
				<button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
			  	...
			  	<form method="post" action="ACAOX_dados.php">    
			  ...
			  <div class="modal-footer"> 
				<button type="button" class="btn btn-danger" data-dismiss="modal" onclick='location.href=location.href="ACAOX.php"'>Fechar</button> 
