	  ...
	  <div id="content">    
		...
		<div class="col-xl-12 col-md-12 mb-12">
		  <div class="card-header py-3 sistema2"> 
			<h6 class="m-0 font-weight-bold">Relatório de Relação do Sobreaviso</h6> 
		  </div>
			<div class="card border-left-primary shadow h-100 py-2">
				<div class="card-body">
				  <div class="row no-gutters align-items-center">
					<form method="post" action="imp_sobreavisodata.php">
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								...
								<select name="Empresa" id="Empresa" class="form-control">
									...
									while ($rowX=ibase_fetch_assoc($tabelaX)){ ?>
									   <option value="<?php ECHO $rowX["RAZAOSOCIAL"]?>"><?php ECHO $rowX["FANTASIA"]?></option>  
									<?php
									}?>  
								</select>
							</div>
